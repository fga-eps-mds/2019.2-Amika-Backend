...
from cadastrar_usuario.views import MultipleRegistrationsViewSet, cadastrar_aluno

class TestUrls(SimpleTestCase):

    def test_set_registration_list_resolves(self):
        url = reverse('set_registration_list')
        self.assertEquals(resolve(url).func.view_class, MultipleRegistrationsViewSet)
